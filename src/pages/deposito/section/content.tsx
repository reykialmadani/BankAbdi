    ...
    return (
      <div className="lg:w-3/4 w-full">
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h4 className="text-2xl font-bold text-gray-900 mb-6">PERSYARATAN</h4>
              ...
              <ol className="list-decimal pl-6 space-y-6 mt-4">
                <li>
                  ...
                  <ol className="list-decimal pl-6 space-y-2 mt-2">
                    <li>PhoKartu Identitas (e-KTP)</li>
                ...
                <li>
                  ...
                  <ol className="list-decimal pl-6 space-y-2 mt-2">
                    ...
                    <li>PhotoAkta Pendirian atau Anggaran Dasar Terakhir berikut Perubahannya</li>
