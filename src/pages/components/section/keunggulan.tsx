...
const Keunggulan = () => {
    return (
        <section className="p-6 mx-auto max-w-8xl" style={segoeUIStyles}>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                <h3 className="text-lg font-bold text-[#003868] mb-4 md:mb-0 md:w-1/3" style={segoeUIStyles}>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-3 md:w-2/3">
                    {features.map((feature, index) => (
                        <div 
                            ...
                            style={segoeUIStyles}
                        >
                            <h3 className="font-bold mb-1" style={segoeUIStyles}>
                                {feature.title}
                            </h3>
                            <p className="text-sm" style={segoeUIStyles}>
                                {feature.description}
                            </p>
                        </div>
                    ))}
