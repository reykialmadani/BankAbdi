          ...
          <div className="lg:w-3/4 w-full">
            <div className="rounded-lg shadow-sm p-6">
              ...
              <ol className="list-decimal pl-6 text-gray-800 space-y-4">
                <li>Laporan Tahunan 2022 .</li>
              </ol>
            </div>
          </div>
        );
      case "2022":
        return <div className="text-black p-6">Laporan Tahunan 2022</div>;
      case "2023":
        return <div className="p-6">Laporan Tahunan 2023</div>;
      case "2024":
        return <div className="p-6">Laporan Tahunan 2024</div>;
      case "2025":
        return <div className="p-6">Laporan Tahunan 2025</div>;
      default:
